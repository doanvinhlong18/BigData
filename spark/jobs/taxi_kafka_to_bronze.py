...
# ─────────────────────────────────────────────────────────────
spark = (
    SparkSession.builder.appName("TaxiEvents-Kafka-To-Bronze")
...
bronze_df = (
    parsed_df.withColumn("event_ts", to_timestamp(col("event_time")))
...
query_request = (
    request_df.writeStream.format("delta")
    .outputMode("append")
...
query_response = (
    response_df.writeStream.format("delta")
    .outputMode("append")
