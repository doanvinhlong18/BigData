...
# ─────────────────────────────────────────────────────────────
spark = (
    SparkSession.builder.appName("Weather-Kafka-To-Bronze")
...
weather_schema = StructType(
    [
        ...
        StructField("wind_speed_15m", DoubleType(), True),
        StructField("wind_gusts_15m", DoubleType(), True),
...
# ─────────────────────────────────────────────────────────────
bronze_df = (
    parsed_df.withColumn("event_time", to_timestamp(col("datetime")))
